...
\title{Лабораторная работа №5 \\ Курс: Защита информации}
...
\begin{document}
 ...
 Установим необходимые параметры \verb'set RHOSTS 192.168.0.107'
 ...
 Команда: \verb'vncviewer 192.168.0.107:5900'
 \begin{figure}[h!]
 	\centering
